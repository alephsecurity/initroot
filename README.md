...
| cedric (Moto G6) | `0xA0100000`   | `0x2000000` | Release, patched `init` and `adbd` to disable SELinux, `set{u,g}id` to shell, capabilities drop and adb auth, etc
| athene (Moto G5) | `0x90000000`   | `0x2000000` | ""
